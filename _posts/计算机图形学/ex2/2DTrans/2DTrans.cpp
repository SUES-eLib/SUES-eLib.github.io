...
CMy2DTransApp::CMy2DTransApp() noexcept
{
	...
	SetAppID(_T("My2DTrans.AppID.NoVersion"));

	// TODO:  在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的 CMy2DTransApp 对象
...
int CMy2DTransApp::ExitInstance()
{
	//TODO: 处理可能已添加的附加资源
	AfxOleTerm(FALSE);
