...
// 2DTransDoc.cpp: CMy2DTransDoc 类的实现
//
...
CMy2DTransDoc::CMy2DTransDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CMy2DTransDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMy2DTransDoc::InitializeSearchContent()
{
...
void CMy2DTransDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
