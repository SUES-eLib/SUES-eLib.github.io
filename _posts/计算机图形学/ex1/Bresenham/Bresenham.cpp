...
BEGIN_MESSAGE_MAP(CBresenhamApp, CWinAppEx)
...
// CBresenhamApp 自定义加载/保存方法

void CBresenhamApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CBresenhamApp::LoadCustomState()
{
}

void CBresenhamApp::SaveCustomState()
{
}
